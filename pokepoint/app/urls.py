...
# ========= API
    ...
    path('api/employees/<int:pk>/', views.EmployeeDetail.as_view(), name='api_employee_detail'),
   # ------- Company
    path('api/companies/', views.CompanyList.as_view(), name='api_company_list'),
    path('api/companies/<int:pk>/', views.CompanyDetail.as_view(), name='api_companies_detail'),
    # ------- TimeCard
    path('api/timecards/', views.TimeCardList.as_view(), name='api_timecard_list'),
    path('api/timecards/<int:pk>/', views.TimeCardDetail.as_view(), name='api_employee_detail'),
  # ------- WorkPlace
